      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        <div className="card mt-1">
          <div className="card-header">
            <div className="card-title">Distribución de los $5,278</div>
          </div>
          <div className="card-body flex flex-col">
            ...
            <div className="flex items-center gap-2.5 py-2.5 border-b border-[var(--border)]">
              ...
              <div className="font-mono text-[13px] font-semibold text-[var(--green)]">$3,828 <span className="text-[10px] text-[var(--muted)] ml-1">72.5%</span></div>
            </div>
            <div className="flex items-center gap-2.5 py-2.5 border-b border-[var(--border)]">
              <div className="w-2.5 h-2.5 rounded-full bg-[var(--purple)] shrink-0"></div>
              <div className="text-[13px] font-medium flex-1">Robinhood (nuevo)</div>
              <div className="font-mono text-[13px] font-semibold text-[var(--purple)]">$1,000 <span className="text-[10px] text-[var(--muted)] ml-1">18.9%</span></div>
            </div>
            <div className="flex items-center gap-2.5 py-2.5 border-b border-[var(--border)]">
              <div className="w-2.5 h-2.5 rounded-full bg-[var(--gold)] shrink-0"></div>
              <div className="text-[13px] font-medium flex-1">Reserva carro (extras)</div>
              <div className="font-mono text-[13px] font-semibold text-[var(--gold)]">$300 <span className="text-[10px] text-[var(--muted)] ml-1">5.7%</span></div>
            </div>
            <div className="flex items-center gap-2.5 py-2.5 border-b border-[var(--border)] border-b-transparent">
              <div className="w-2.5 h-2.5 rounded-full bg-[var(--blue)] shrink-0"></div>
              <div className="text-[13px] font-medium flex-1">Adstrategic LLC</div>
              <div className="font-mono text-[13px] font-semibold text-[var(--blue)]">$150 <span className="text-[10px] text-[var(--muted)] ml-1">2.8%</span></div>
            </div>
          </div>
        </div>
